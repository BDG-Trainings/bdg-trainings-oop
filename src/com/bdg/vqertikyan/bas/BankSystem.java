...
public final class BankSystem {
    ...
    public static void main(String[] args) {
        ...
        Account account2 = bankService.create("name2", "surname2", Country.IT, "street2", "phone2", 1000);
        Account account3 = bankService.create("name3", "surname3", Country.IT, "street3", "phone3", 3000);
        Account account4 = bankService.create("name4", "surname4", Country.IT, "street4", "phone4", 4000);

        bankService.transfer(account3, account2, 300);
        bankService.findAllAccountWithBalanceRange(1000, 3000);
