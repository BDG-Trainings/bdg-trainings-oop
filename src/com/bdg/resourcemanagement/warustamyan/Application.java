...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Address[] addressesEmp_1 = new Address[1];
        addressesEmp_1[0] = addressEmp_1;
        ...
        Address[] addressesEmp_2 = new Address[1];
        addressesEmp_2[0] = addressEmp_2;
        ...
        employees[0] = employee_1;
        employees[1] = employee_2;
